...
@ccclass('WorldPositionScan')
export class WorldPositionScan extends Component {
    ...
    update(deltaTime: number) {
        ...
        if (this.started) {
            this.scanDistance += this.scanSpeed * deltaTime;
            if (this.scanDistance > this.maxScanDistance) {
                this.started = false;
                this.scanDistance = 0;
            }
